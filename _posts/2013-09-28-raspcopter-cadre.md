...
En revanche, mon travail de programmation et de documentation concernera la conception du système de contrôle de vol intégré au Raspberry Pi. À commencer par la réception de "l'attitude" (la rotation dans l'espcace) du quadcopter en angles d'euler filtrés puis le système linéaire continu et invarient (contrôleur PID pour les intimes) et la régulation des vitesses via le Pololu Maestro.
